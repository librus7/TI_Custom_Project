...
/**
 * This is the Pane for the Master.
 *  
 *
 *
 */
public class MasterPane extends ExtensionWebPane {

    private static final Logger LOG = LoggerFactory.getLogger(MasterPane.class);
    private static final long serialVersionUID = 1L;


    private MasterExtensionDriverPWrapper driverWrapper;

    public final void setDriverWrapper(MasterExtensionDriverPWrapper driverWrapper) {
        this.driverWrapper = driverWrapper;
    }

    public MasterExtensionDriverPWrapper getDriverWrapper() {
