...
import com.misys.tiplus2.customisation.extensions.AbstractEventStepExtension;
...
/**
 * Customisation class for ExtEventStep
 *
 */
public class EventStepExtension extends AbstractEventStepExtension {

    private static final Logger LOG = LoggerFactory.getLogger(EventStepExtension.class);

    private ExtEventStepExtensionDriverP eventStepExtensionPane;

    @Override
    protected final ExtEventStepWrapper getWrapper() {
        return (ExtEventStepWrapper) super.getWrapper();
    }

    public final EventStepPane getPane() {
        return (EventStepPane) super.getCustomisedPane();
    }

    @Override
    protected final ExtEventStepExtensionDriverPWrapper getDriverWrapper() {
     return (ExtEventStepExtensionDriverPWrapper) super.getDriverWrapper();
    }
    ...
    public final void initialise(EnigmaExtensionPane extensionPane) {
        ...
        eventStepExtensionPane = (ExtEventStepExtensionDriverP) extensionPane;

        //set reference to the wrapper in the superclass
        setWrapper(new ExtEventStepWrapper(eventStepExtensionPane.getExtEventStep()));

        //set reference to the driver wrapper in the superclass
        setDriverWrapper(new ExtEventStepExtensionDriverPWrapper(eventStepExtensionPane));
        ...
        setParameters(eventStepExtensionPane.getParameters());
    ...
    public final void initialise() {
        ...
        CommonModule.initialiseEventStep(getWrapper());
