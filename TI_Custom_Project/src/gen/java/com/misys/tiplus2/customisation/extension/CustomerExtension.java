...
import com.misys.tiplus2.customisation.extensions.AbstractCustomerExtension;
...
/**
 * Customisation class for ExtCustomer
 * <p>StaticExtensionHandler.java.vm
 */
public class CustomerExtension extends AbstractCustomerExtension {

    private static final Logger LOG = LoggerFactory.getLogger(CustomerExtension.class);

    
    @Override
    protected final ExtCustomerWrapper getWrapper() {
        return (ExtCustomerWrapper) super.getWrapper();
    }

    public final CustomerPane getPane() {
        return (CustomerPane) super.getCustomisedPane();
    }

    @Override
    protected final ExtCustomerExtensionDriverPWrapper getDriverWrapper() {
        return (ExtCustomerExtensionDriverPWrapper) super.getDriverWrapper();
    }
    ...
    public final void initialise(EnigmaExtensionPane extensionPane) { 
        ...
        setWrapper(new ExtCustomerWrapper(((ExtCustomerExtensionDriverP) extensionPane).getExtCustomer()));

        /* set reference to the driver wrapper in the superclass */
        setDriverWrapper(new ExtCustomerExtensionDriverPWrapper((ExtCustomerExtensionDriverP) extensionPane));
        ...
        setParameters(((ExtCustomerExtensionDriverP) extensionPane).getParameters());
    ...
    public final void initialise() {
        ...
        CommonModule.initialiseCustomer(getWrapper());
    ...
    public final void postInitialise() {
        ...
        try {
            ...
            getPane().setAgentWithholdingPercentage(getWrapper().getAgentWithholdingPercentage());
    ...
    public final void journal() {
        ...
        getJournalDetails().addJournal("Agent Withholding Percentage", "i", getNullSafeString(getWrapper().getAgentWithholdingPercentage()));
 ...
 /**
    ...
    public final void getFieldCodeInteger(String fieldCode) {
        ...
        try {
            if (fieldCode.equals("cAAA")) {
                getParameters().getReturnInteger().assignEn(getWrapper().getAgentWithholdingPercentage());
                getParameters().getBSuccess().assignEn(true);
    ...
    public final void putFieldCodeInteger(String fieldCode) {
        ...
        try {
            if (fieldCode.equals("cAAA")) {
                getWrapper().setAgentWithholdingPercentage(getParameters().getReturnInteger().getEnValue());
                getPane().setAgentWithholdingPercentage(getWrapper().getAgentWithholdingPercentage());
                getParameters().getBSuccess().assignEn(true);
                return;
            }
