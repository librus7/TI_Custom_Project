...
/**
 * This is the Pane for the TICustomer.
 *  
 *
 *
 */
public class TICustomerPane extends ExtensionWebPane {

    private static final Logger LOG = LoggerFactory.getLogger(TICustomerPane.class);
    private static final long serialVersionUID = 1L;


    private ExtTICustomerExtensionDriverPWrapper driverWrapper;

    public final void setDriverWrapper(ExtTICustomerExtensionDriverPWrapper driverWrapper) {
        this.driverWrapper = driverWrapper;
    }

    public ExtTICustomerExtensionDriverPWrapper getDriverWrapper() {
