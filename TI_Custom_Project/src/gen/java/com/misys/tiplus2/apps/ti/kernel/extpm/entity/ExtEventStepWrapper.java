...
public class ExtEventStepWrapper extends EnigmaCustomisedEntityWrapper {

    private static final Logger LOG = LoggerFactory.getLogger(ExtEventStepWrapper.class);

    public ExtEventStepWrapper(Key_ExtEventStep<? extends ExtEventStep> key) {
        super(key);
    }

    @SuppressWarnings("unchecked")
    @Override
    public final Key_ExtEventStep<? extends ExtEventStep> getKey() {
        return (Key_ExtEventStep<? extends ExtEventStep>) super.getKey();
    }
