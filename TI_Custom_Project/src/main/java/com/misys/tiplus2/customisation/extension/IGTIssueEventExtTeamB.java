...
public class IGTIssueEventExtTeamB {
	...
	public void onValidate(ValidationDetails validationDetails) {
		...
		validationDetails.addWarning(WarningType.Other, String.format("TEAM_B: agentAmountWr=%s , agentWithholdingAmountWr=%s", agentAmountWr, agentWithholdingAmountWr));
		validationDetails.addWarning(WarningType.Other, String.format("TEAM_B: agentAmountPn=%s , agentWithholdingAmountPn=%s", agentAmountPn, agentWithholdingAmountPn));
